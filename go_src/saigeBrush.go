...
func checkInput(MAC, MAF, phenoFile, pheno, covars, sampleID string) {
	...
	var allCovsSplit = make([]string, 0)
	if covars == "" {
		fmt.Printf("[func(checkInput)] -- UPDATE! -- No covariates are listed your phenotype file. Proceeding without covariates. \n\t%v")
	} else {
	...
	if (parserMap.GenerateResults == true) && (parserMap.GenerateAssociations == false) {
